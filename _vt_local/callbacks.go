...
type Callbacks struct {
	...
	// ScrollOut callback. When set, this function is called when a line scrolls
	// off the top of the screen via ScrollUp. The plain and styled strings
	// represent the line content without and with ANSI escape codes respectively.
